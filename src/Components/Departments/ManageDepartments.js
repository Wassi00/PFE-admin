        ...
        >
          <Card className="max-w-sm">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Ajouter un nouveau département au système
            </p>
            <Button onClick={navA}>
              Créer
              <svg
          ...
          <Card className="max-w-sm">
            <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Modifier une département
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Modifier les détails d'un département existant
            </p>
            <Button onClick={navE}>
              Modifier
              <svg
          ...
          <Card className="max-w-sm">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Supprimer un département existant dans la base des données
            </p>
            <Button onClick={navD}>
              Supprimer
              <svg
