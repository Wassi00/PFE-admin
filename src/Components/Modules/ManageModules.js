        ...
        >
          <Card className="max-w-sm">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Ajouter un nouveau module au système
            </p>
            <Button onClick={navA}>
              Créer
              <svg
          ...
          <Card className="max-w-sm">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Modifier les détails d'un module existant
            </p>
            <Button onClick={navE}>
              Modifier
              <svg
          ...
          <Card className="max-w-sm">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              Supprimer un module existant dans la base des données
            </p>
            <Button onClick={navD}>
              Supprimer
              <svg
