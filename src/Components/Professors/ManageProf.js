    ...
    <div>
      ...
      >
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-lg overflow-auto">
          <h1 className="text-white font-bold mb-4">Gestion des professeurs</h1>
          <div className="mb-5">
            <div className="mb-2 block">
              <Label
                htmlFor="formations"
                value="Choisir une méthode de recherche"
              />
            </div>
            <Select
              id="formations"
              ...
              className="mb-5"
            >
              <option value="cin">Chercher par CIN</option>
              <option value="department">Chercher par Départment</option>
            </Select>
            ...
            {searchBy === "department" && (
              <>
                <div className="mb-2 block">
                  <Label
                    htmlFor="formations"
                    value="Sélectionner un Départment"
                  />
                </div>
                <Select
                  id="formations"
